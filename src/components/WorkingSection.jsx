...
export default function WorkingSection() {
  return (
    <section className="max-w-[1400px] mx-auto px-[3%] pt-24">
      ...
      <h2 className="bg-clip-text text-transparent bg-custom-gradient-text text-2xl text-center pb-10 sm:max-w-[40%] md:max-w-[50%] lg:max-w-[50%] mx-auto md:text-3xl lg:text-4xl xl:text-5xl">
